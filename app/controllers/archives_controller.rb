...
class ArchivesController < ApplicationController
  ...
  def archive_params
    params.require(:archive).permit(:identifier, :registration_date, :location, :originator_agent, :recipient_agent, :production_date, :transmission_date, :reception_date, :related_activities, :related_documents, :title, :subject, :description, :coverage, :language, :encoding_format, :media_type, :compression_encryption, :hardware_software_dependencies, :aggregation_level, :extent, :preservation_responsibility, :preservation_action_date, :preservation_activity_type, :preservation_impact, :next_preservation_action, :physical_storage_support, :access_use_history, :file)
  end
end
